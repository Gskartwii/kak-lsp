...
declare-option -docstring "Character to represent a single inlay diagnostic of many on a line" str lsp_inlay_diagnostic_sign '■'
declare-option -docstring "Character(s) to separate the actual line contents from the inlay diagnostics" str lsp_inlay_diagnostic_gap '     '
